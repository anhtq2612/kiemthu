        ...
        <Card title="Thêm mới">
            ...
            <img src={img} width={200}/>
                <div className='flex flex-col w-full'>
                    ...
                    <Form.Item name="vitriungtuyen" label="Vị trí ứng tuyển">
                        <Input onChange={(e) => setImg(e.target.value)} value={img}/>
                    </Form.Item>
                </div>
            </div>
